import type { Doctor, IArticleCardProps, IService, ITestimonial, Services, Tag } from "../interfaces";
...
export const services: IService[] = [
  {
    ...
    name: "الكشف العام",
    details: "فحص شامل للحالة الصحية العامة مع تقييم دقيق من أطباء متخصصين وإعداد تقرير طبي مفصل.",
  },
  {
    id: 2,
    image: "https://images.unsplash.com/photo-1666214280557-f1b5022eb634?w=400",
    name: "الأشعة والتصوير الطبي",
    details: "خدمات أشعة متكاملة تشمل الأشعة السينية والرنين المغناطيسي والأشعة المقطعية بأحدث الأجهزة.",
  },
  {
    id: 3,
    image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=400",
    name: "تحاليل المختبر",
    details: "تحاليل دم وبول وأنسجة بدقة عالية مع ظهور النتائج خلال ساعات معدودة.",
  },
  {
    id: 4,
    image: "https://images.unsplash.com/photo-1571772996211-2912789b5a3a?w=400",
    name: "طب الأسنان",
    details: "علاج وتجميل الأسنان بأحدث التقنيات، يشمل الحشوات والتقويم والزراعة وتبييض الأسنان.",
  },
  {
    id: 5,
    image: "https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=400",
    name: "طب العيون",
    details: "فحص وعلاج أمراض العيون وتصحيح النظر بالليزر مع توفير أحدث العدسات والنظارات الطبية.",
  },
  {
    id: 6,
    image: "https://images.unsplash.com/photo-1584515933487-779824d29309?w=400",
    name: "العلاج الطبيعي",
    details: "جلسات علاج طبيعي متخصصة لإعادة التأهيل وعلاج آلام العظام والمفاصل والعضلات.",
  },
];
...
export const testimonials: ITestimonial[] = [
  {
    ...
    review: "خدمة ممتازة واحترافية عالية، تعاملت معهم في مشروع كبير وكانوا على قدر المسؤولية في كل خطوة. أنصح الجميع بالتعامل معهم بكل ثقة."
  },
  {
    id: 2,
    name: "فاطمة علي حسن",
    ...
    review: "تجربة رائعة من البداية للنهاية، الفريق محترف ومتعاون جداً. شعرت بالراحة والثقة طوال فترة التعامل معهم."
  },
  {
    id: 3,
    ...
    review: "من أفضل الشركات التي تعاملت معها، الدقة في المواعيد والالتزام بالعقود شيء نادر في السوق. سأستمر في التعامل معهم بالتأكيد."
  },
  {
    id: 4,
    ...
    review: "أعجبني جداً مستوى الشفافية والوضوح في التعامل، لا توجد أي تفاصيل مخفية. فريق عمل رائع وخدمة عملاء متميزة."
  },
  {
    id: 5,
    name: "يوسف حمدي نصر",
    ...
    review: "تعاملت معهم في قضية معقدة وأبهرني مستوى الكفاءة والدقة. يمكن الاعتماد عليهم بشكل كامل في أصعب المواقف."
  },
  {
    id: 6,
    name: "سارة محمود طه",
    ...
    review: "خدمة احترافية بامتياز، الفريق يفهم احتياجات العميل ويعمل بجد لتحقيقها. النتيجة دائماً تفوق التوقعات."
  },
];
...
export const faqs = [
  {
    ...
    answer: "العيادة مفتوحة من السبت إلى الخميس من الساعة ٩ صباحاً حتى ٩ مساءً، وأيام الجمعة من ٤ عصراً حتى ٩ مساءً."
  },
  {
    id: 2,
    question: "كيف يمكنني حجز موعد؟",
    answer: "يمكنك حجز موعدك بسهولة عن طريق الاتصال بنا على الرقم الموجود في صفحة التواصل، أو من خلال نموذج الحجز الإلكتروني على موقعنا."
  },
  {
    id: 3,
    question: "هل تقبلون التأمين الطبي؟",
    answer: "نعم، نتعامل مع معظم شركات التأمين الطبي. يُرجى التواصل معنا مسبقاً للتأكد من تغطية تأمينك قبل الزيارة."
  },
  {
    id: 4,
    question: "ما هي التخصصات المتوفرة في العيادة؟",
    answer: "تضم عيادتنا تخصصات متعددة منها الباطنة، طب الأطفال، الجلدية، العظام، وطب الأسنان. كل تخصص له طاقم طبي متخصص وذو خبرة عالية."
  },
  {
    id: 5,
    question: "كم تستغرق مدة الانتظار عادةً؟",
    answer: "نحرص على احترام وقت مرضانا، ومتوسط وقت الانتظار لا يتجاوز ١٥ دقيقة للمواعيد المحجوزة مسبقاً."
  },
  {
    id: 6,
    question: "هل تتوفر خدمة الكشف المنزلي؟",
    answer: "نعم، نوفر خدمة الزيارات المنزلية لحالات معينة وللمرضى الذين يصعب عليهم التنقل. يمكن التواصل معنا لترتيب الزيارة."
  },
  {
    id: 7,
    question: "هل يمكنني الاطلاع على نتائج التحاليل إلكترونياً؟",
    answer: "نعم، نوفر خدمة إرسال نتائج التحاليل والأشعة عبر البريد الإلكتروني أو واتساب بعد مراجعة الطبيب المختص."
  },
  {
    id: 8,
    question: "ما هي إجراءات الطوارئ في العيادة؟",
    answer: "يتوفر لدينا خط طوارئ على مدار الساعة للحالات الحرجة، كما يوجد طاقم طبي مدرب للتعامل مع الطوارئ داخل العيادة فور وصول المريض."
  },
];
